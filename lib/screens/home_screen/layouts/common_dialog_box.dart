...
import 'home_screen_upper_layout/demodemo.dart';
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                WheelSlider(
                  ...
                  customPointer: SvgPicture.asset("assets/svg/ruler.svg")
                      .paddingOnly(top: 40),
                  totalCount: homeScreenPvr.totalCount,
                  initValue: homeScreenPvr.initValue,
                  onValueChanged: (val) => homeScreenPvr.sleepSlider(val),
                ),

                const SizedBox(height: 20),
                Text(
                  'Current Value: ${homeScreenPvr.currentValue}',
