    ...
    return Consumer<DashboardProvider>(
        builder: (context1, dashboardPvr, child) {
          ...
          return StatefulWrapper(
              onInit: () =>
                  Future.delayed(DurationsClass.ms150)
                                ...
                                children: [
                                  ...
                                  Container(
                                      ...
                                      child: ExpansionTile(
                                          ...
                                          title: Text(
                                              "${dashboardPvr.startedRange ??
                                                  appFonts
                                                      .selectFromDate} ${dashboardPvr
                                                  .startedRange == null
                                                  ? appFonts.and
                                                  : appFonts.to} ${dashboardPvr
                                                  .endedRange ??
                                                  appFonts.toDate}",
                                          ...
                                          children: <Widget>[
                                            TableCalendar(
                                                ...
                                                rangeStartDay: dashboardPvr
                                                    .rangeStart,
                                                rangeEndDay: dashboardPvr
                                                    .rangeEnd,
                                                    ...
                                                    leftChevronIcon: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            ...
                                                            color: appColor(
                                                                ...
                                                                0.10)),
                                                        child: SvgPicture.asset(
                                                            "assets/svg/leftSide.svg")),
                                                    leftChevronMargin: const EdgeInsets
                                                        .only(left: 50),
                                                    rightChevronMargin: const EdgeInsets
                                                        .only(right: 50),
