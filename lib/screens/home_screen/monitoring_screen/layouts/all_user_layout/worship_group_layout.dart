...
class WorshipGroupLayout extends StatelessWidget {
  const WorshipGroupLayout({super.key});
      ...
      return SingleChildScrollView(
          ...
          child: ClipRRect(
              ...
              child: DataTable(
                  ...
                  columns: monitoringPvr.worshipDataColumn(),
                  rows: List<DataRow>.generate(
                      monitoringPvr.worshipDataRow().length, (index) {
